...
class Pix2StructLargeVisionTower(nn.Module):
    ...
    def load_model(self):
        if self.is_loaded:
            return
        whole_model = Pix2StructForConditionalGeneration.from_pretrained(self.args.vision_tower_pretrained_from)
        self.vision_tower = whole_model.encoder
        del whole_model
        self.pix2struct_processor = AutoProcessor.from_pretrained(self.args.vision_tower_pretrained_from)
