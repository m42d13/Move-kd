...
class SAMVisionTower(nn.Module):
    ...
    def load_model(self):
        ...
        self.image_processor= SamProcessor.from_pretrained(self.args.vision_tower_pretrained_from)
        sam_model = SamModel.from_pretrained(self.args.vision_tower_pretrained_from).vision_encoder
