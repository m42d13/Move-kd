...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path ./playground/data/llava_v1_5_debug_8.json \
    --image_folder ./playground/data/LLaVA-Pretrain \
    --vision_tower openai/clip-vit-large-patch14-336 \
    --pretrain_mm_mlp_adapter ./checkpoints/pretrain/debug-move-kd-7b-v1.1/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/finetune/debug-adapter-move-kd-7b-v1.1 \
    --num_train_epochs 1 \
    --max_steps 1 \
    ...
    --kd_w 0.5 \
    --kd_memory_w 0.8 \
    --pretrain_mole_encoder ./checkpoints/pretrain/debug-move-kd-7b-v1.1/mole_encoder.bin \
    --pretrain_encoder_adapter ./checkpoints/pretrain/debug-move-kd-7b-v1.1/encoder_adapter.bin \
